...
import { getExternalConsultationReply, listExternalConsultationDocuments, writeExternalConsultationReply } from "@/lib/google-consultation-docs";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (documentId) return NextResponse.json({ ok: true, answer: await getExternalConsultationReply(documentId) });
