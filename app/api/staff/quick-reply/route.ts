...
const overallBuiltInCopy: Record<string, string> = {
  ...
  body_headache: "頭部容易緊、容易痛，壓力大或睡不夠時會更明顯。",
  body_dizziness: "近期會有頭暈、精神不集中或突然沒力的情況，空腹和睡眠不足時要特別注意。",
  body_sleep: "睡眠不穩，會有難睡、半夜醒或睡醒還是累的情況。作息要固定下來。",
  body_eyes: "眼睛容易乾澀疲勞，看手機、電腦太久就會不舒服，要固定休息。",
  body_neck: "肩頸會緊、會痠，久坐和低頭之後最明顯，姿勢要調整。",
  body_back: "腰背容易痠痛，搬重物和久坐都會加重，最近不要硬撐。",
  body_stomach: "腸胃敏感，吃太快、太晚或刺激性食物都會有反應，飲食時間要固定。",
  body_cold: "體質偏寒，手腳容易冷，冷氣、冰飲和熬夜都會讓狀況更明顯。",
  body_allergy: "近期容易過敏，皮膚、鼻子或眼睛會先有反應，換季和環境灰塵要注意。",
  body_breath: "呼吸道敏感，換季、空氣差或吹冷風時容易咳嗽、鼻塞或喉嚨不舒服。",
  body_circulation: "循環偏弱，久坐後手腳容易麻、腫或冰冷，每天要起來活動。",
  body_pressure: "血壓有起伏，壓力大、沒睡好時更明顯，要固定量測。",
  body_liver: "肝膽代謝要注意，熬夜、喝酒和油膩飲食會直接反映在精神與身體上。",
  body_kidney: "泌尿和腎臟要注意，水分不足、憋尿後容易出現不舒服。",
  body_joint: "關節容易痠、卡或無力，運動前要熱身，最近不要突然做高強度活動。",
  body_fatigue: "近期容易累，精神和體力掉得快。睡眠不足時不要硬撐工作。",
  body_female_gynecology: "婦科要注意，已經有分泌物、疼痛或反覆不舒服就要安排檢查。",
  body_female_cycle: "生理期和荷爾蒙會亂，經期、經量或疼痛有明顯變化就要處理。",
  body_male_prostate: "攝護腺要注意，排尿變慢、頻尿或夜尿增加就要安排檢查。",
  body_male_urinary: "男性泌尿狀況要注意，疼痛、頻尿或排尿異常不要拖。",
  body_positive_energy: "精神和體力穩，日常工作撐得住，近期沒有看到明顯虛弱的狀況。",
  body_positive_recovery: "身體恢復力好，小病小痛休息後就能恢復，不會拖很久。",
  body_positive_sleep: "睡眠大致安穩，能睡得進去，也能得到休息，精神恢復得回來。",
  body_positive_stomach: "腸胃吸收正常，飲食和消化沒有大問題，維持現在的習慣就好。",
  body_positive_mobility: "筋骨活動穩定，走動、工作和日常活動沒有明顯阻礙。",
  body_positive_circulation: "氣色和循環不錯，整體精神看起來有起來，身體底子也守得住。",
};
